...
st.markdown('''<div style="text-align:center;padding:2rem 0 .5rem;border-top:1px solid #1A2740;margin-top:2rem;"><div style="font-family:'IBM Plex Mono',monospace;font-size:.65rem;color:#1E2D3D;letter-spacing:.08em;">Abdullah Ibrahim M.Sc. Candidate in Computer Science · AI Specialization · Cairo University.</div></div>''', unsafe_allow_html=True)
